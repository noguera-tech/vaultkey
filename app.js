...
function setEntryType(type){
  ...
  const catMap={id:'otros',license:'otros',medical:'otros',wifi:'wifi',password:'',note:'',card:'banco'};
  const eCat=$('eCategory');
  if(eCat&&catMap[type]!==undefined&&catMap[type]!==''){eCat.value=catMap[type];}
}
